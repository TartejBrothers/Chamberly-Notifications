        ...
        NavigationView {
            ...
            List {
                Section(header: Text("Today").textCase(.none)) {
                    ...
                    UserNotification2(name: "Iram", image: "iram",time: "18 mins Ago")
                ...
                Section(header: Text("Yesterday").textCase(.none)) {
                    ...
                    UserNotification(name: "Cui Yin", image: "cui",time: "18 mins Ago")
                    
                    UserNotification2(name: "Iram", image: "iram",time: "18 mins Ago")
                    
                    UserNotification(name: "Jack", image: "jack", time: "18 mins Ago")
                ...
                Section(header: Text("Last 7 days").textCase(.none)) {
                    ...
                    UserNotification(name: "Cindy", text: "Joined Your Chamber", image: "cindy",time: "18 mins Ago")
                ...
                Section(header: Text("Older Notifications").textCase(.none)) {
                    ...
                    UserNotification(name: "John", image: "john",time: "18 mins Ago")
